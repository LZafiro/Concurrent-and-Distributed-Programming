...
/*
* Compile: gcc -o without busy_wait_without_mutual_exclusion.c -pthread (dont use any optimizer, may cause problems)
* Run: ./without NUM_C_THREADS
*/
